...
export default class DaysEventsScreen extends Component {
    ...
    getMyPermission(){
        ...
        return this.props.route.params.calendar.roles[firebase.auth().currentUser.uid];
    }
        ...
        this.unsubscribeListener = firebase
            ...
            .doc(this.props.route.params.calendar.id)
                ...
                .onSnapshot(querySnapshot => {
                    ...
                    querySnapshot.forEach((doc) =>  newEvents = [...newEvents, { ...doc.data(), id: doc.id }]);
    ...
    renderResults(){
        ...
        items = this.state.events.map((event, index) => {
            ...
            return (
                <List.Item
                    title={event.title}
                    description={event.desc.length > 20 ? `${event.desc.substr(0, 20)}...` : event.desc}
    ...
    onDeleteEvent(){
        ...
        firebase
            ...
            .collection("calendars")
            .doc(this.props.route.params.calendar.id)
                .collection("events").doc(this.currentId)
                .delete()
                .then(deleted => {
                    this.setState({
                        ...this.state,
